...
## change defualt output to match the doc

## make sure miliseconds works

## rename files the way i want

## fill a list with None (each element corresponds to a millisecond), and then change each index with tagj
...
def import_data(file_input,interval):
    ...
    returns a list of the time intervals seperated into tags (Behavior,Attention,Emotion)
    '''
...
if __name__ == "__main__":
    print(find_cronbachs("resources/p01_s02.txt", "resources/P01_S02_wellness_Emily.txt",1000))
